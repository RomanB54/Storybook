/*! For license information please see 735.85a9e217.iframe.bundle.js.LICENSE.txt */
'use strict';
    ...
    './node_modules/react-dom/cjs/react-dom-client.production.js': (
        ...
        try {
          ...
          !(function updateProperties(domElement, tag, lastProps, nextProps) {
            switch (tag) {
              ...
              case 'textarea':
                for (defaultValue in ((propKey = propKey$205 = null),
                lastProps))
                  if (
      ...
      function flushSyncWorkAcrossRoots_impl(syncTransitionLanes, onlyLegacy) {
        if (!isFlushingWork && mightHavePendingSyncWork) {
          ...
          do {
            for (
              var didPerformSomeWork = !1, root$174 = firstScheduledRoot;
              null !== root$174;
